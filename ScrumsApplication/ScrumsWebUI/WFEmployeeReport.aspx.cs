...
namespace ScrumsWeb
{
	public partial class WFEmployeeReport : System.Web.UI.Page
	{
        ...
        {
			DataTable table = scrumManager.GetWfEmployeeReports(employeeCode, bankCode, startDate, endDate);

            var data = ScrumWfEmployeeReport.CreateReportFromDataTable(table);
