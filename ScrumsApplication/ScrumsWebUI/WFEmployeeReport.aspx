<%@ Page Language="C#" Title="WF İlgili Toplamları" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WFEmployeeReport.aspx.cs" Inherits="ScrumsWeb.WFEmployeeReport" %>
    ...
    <div class="row g-2">
        ...
        <div class="col-md-12">
            <div class="card p-2 px-4">
                <h4 class="text-center mt-2">WF İlgili Toplamları Raporu</h4>
                <div class="row mt-3">
                    <div class="col-md-2">
...
<asp:Content runat="server" ID="Content2" ContentPlaceHolderID="HeadScriptsContent">
    <script src="Scripts/Tables/wfEmployeeReport.js"></script>
</asp:Content>
