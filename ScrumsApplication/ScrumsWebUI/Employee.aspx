<%@ Page Language="C#" Title="İlgili Tanımları" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Employee.aspx.cs" Inherits="ScrumsWeb.Employee" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card p-2 px-4 pb-3">
                <h4 class="text-center mt-2">İlgili Tablosu</h4>
...
<asp:Content runat="server" ID="Content2" ContentPlaceHolderID="HeadScriptsContent">
    <script src="Scripts/Tables/employee.js"></script>
</asp:Content>
